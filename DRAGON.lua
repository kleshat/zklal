...
if res ~= 200 then
print('\27[0;31m⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/kleshat/zklal/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1944028567,400099998887777,1058949070,1058949070}   
...
if tonumber(user_id) == tonumber(1944028567) then  
var = 'المرمج فرعون الكبير '
elseif tonumber(user_id) == tonumber(1885706669) then
var = 'المبرمج زغلل الكبير '
...
local UserName = (data.username_ or "AP_XO")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟𓏴   𓆪.")  
...
if text == 'السورس زغلل 🌚💞' then
local Text = 'اليك المبرمج زغلل'
local Key = {
...
{'اوامر المسح','اوامر التفعيل ','اوامر الحمايه'},
...
os.execute('wget https://raw.githubusercontent.com/kleshat/zklal/main/DRAGON.lua')
...
local Text = [[ 
[قناه سورس فرعون ادخل وتابع الجديد](t.me/AP_XO)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AP_XO/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/AP_XO)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/AP_XO"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "توكين البوت" and SudoBot(msg) or text == 'عرض الوكين' and SudoBot(msg) then 
if not DevSoFi(msg) then
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 👨‍🎤 من أحسن السورسات على التليجرام سورس زغلل 👨‍🎤
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟', url="t.me/AP_XO"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AP_XO/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👨‍🎤 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'AP_XO')..') \n👨‍🎤 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
local Text =[[
☑ [𝗕𝙊𝙏 𝙏𝙊𝗔𝗦𝗟](t.me/Mahmu_d_bot)

☑ [⟦𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟 ⟧](t.me/AP_XO)
  
☑ [𝗗𝙀𝗩 𝗭𝗞𝗟𝗔𝗟 ](t.me/M_ahmu_d)
]]
keyboard = {} 
keyboard.inline_keyboard = {
	
{{text = ' ◍ 𝗗𝙀𝗩 𝗭𝗞𝗟𝗔𝗟  𖣌 ', url = "https://t.me/M_ahmu_d"}},

{{text = ' ◍ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟 𖣌 ', url = "https://t.me/AP_XO"}},

{{text = ' ◍ 𝗕𝙊𝙏 𝙏𝙊𝗔𝗦𝗟 𖣌 ', url = "https://t.me/Mahmu_d_bot"}},


{ {text = 'اضف البوت لمجموعتك 🌚💞', url="http://t.me/"..sudos.UserName.."?startgroup=new"}, },
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/hdhsjuei/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👨‍🎤 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'AP_XO')..') \n👨‍🎤 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👨‍🎤 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'AP_XO')..') \n👨‍🎤 تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع حظر المبرمج زغلل")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1944028567) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع حظر المبرمج فرعون الكبير")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1986403229) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع حظر المبرمج منيل عام")
return false 
end
...
if result.id_ == tonumber(1944028567) then
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا يمكنك حظر المبرمج فرعون الكبير \n")
return false 
end
if result.id_ == tonumber(1986403229) then
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا يمكنك حظر المبرمج منيل \n")
return false 
end
...
if tonumber(userid) == tonumber(1944028567) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع حظر المبرمج فرعون الكبير ")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1885706669) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع كتم المبرمج زغلل")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1944028567) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع كتم المبرمج فرعون الكبير")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1986403229) then  
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا تسطيع كتم المبرمج منيل عام")
return false 
end
...
if result.id_ == tonumber(1885706669) then
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا يمكنك كتم المبرمج زغلل\n")
return false 
end
if result.id_ == tonumber(1944028567) then
...
if result.id_ == tonumber(1986403229) then
send(msg.chat_id_, msg.id_, " 👨‍🎤 لا يمكنك كتم المبرمج منيل \n")
return false 
end
usertext = '\n 👨‍🎤 العضو 👨‍🎤 ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
status  = '\n 👨‍🎤 تم كتمه عام من الجروبات'
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/kleshat/zklal/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/kleshat/zklal/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👨‍🎤 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'AP_XO')..')'
status  = '\n👨‍🎤 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع فرعون") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع فرعون @(.*)$") and SudoBot(msg) then
...
if text and text:match("^رفع فرعون (%d+)$") and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n👨‍🎤 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'AP_XO')..')'
status  = '\n👨‍🎤 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n👨‍🎤 العضو » '..userid..''
...
if AddChannel(msg.sender_user_id_) == false then
local AP_XO = database:get(bot_id..'text:ch:user')
if AP_XO then
send(msg.chat_id_, msg.id_,'['..AP_XO..']')
else
send(msg.chat_id_, msg.id_,' 👨‍🎤 لا تستطيع استخدام البوت \n  👨‍🎤 يرجى الاشتراك بالقناه اولا \n  👨‍🎤 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
----------------------------------------- انتهاء كشف المجموعة
if text == 'VIP الفرعون' and Mod(msg) then    
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟𓏴   𓆪ـــــــــــــــــــــ≫ٴ'..
...
'\n𖤛︙  علامة ال {🔓} تعني مفعل'..
'\n𖤛︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟??   𓆪ـــــــــــــــــــــ≫ٴ'..
'\n'..'𖤛︙  امر صيح » { '..kickme..
...
' }\n'..'𖤛︙  الرفع » { '..setadd..
' }\n'..'𖤛︙  الحظر » { '..banm..' }\n\nٴ≪ـــــــــــــــــــــ𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n𖤛︙ قناة سورس الوون ↓\n [ ❍ ┇𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟𓏴   𓆪.](t.me/SOURCE_SYRIA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{
{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟 ⤶', url="https://t.me/AP_XO"},
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👨‍🎤 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'AP_XO')..')'..'\n👨‍🎤 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."AP_XO:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'👨‍🎤 تم تفعيل الانستا')
database:set(bot_id.."AP_XO:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."AP_XO:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."AP_XO:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"👨‍🎤︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."AP_XO:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."AP_XO:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'AP_XO')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚\nاضغط علي الاسم ليتم نسخه\n⚚━━━━━⚚ 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚\n 👨‍🎤 ❲[𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟 ☽‘](t.me/M_ahmu_d)❳ 👨‍🎤 ')
end
...
⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚
👨‍🎤 اليك الاوامر الخاص بسورس فرعون .
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/AP_XO)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂👨‍🎤](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/AP_XO)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/AP_XO)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/AP_XO)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DEV_FRAWN/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚
👨‍🎤 𝘾𝙃 - [𓌹 ᯓ المبرمج زغلل](t.me/M_ahmu_d) 
⚚━━━━━⚚ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟⚚━━━━━⚚
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{
{text = 'المبرمج زغلل',url="t.me/M_ahmu_d"}
},  
{{text = '𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗞𝗟𝗔𝗟', url="t.me/AP_XO"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/hdhsjuei/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end



if text == 'المبرمج زغلل' or text == 'زغلل' then  
local Text = [[
🛑لتواصل مع المبرمج زغلل 🌚💞
...
if text == 'المبرمج فرعون' or text == 'فرعون' then  
local Text = [[
...
if text == 'العاب فرعون ' or text == 'الالعاب المتطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '👨‍🎤قنـآة السـورس 👨‍🎤', url="https://t.me/AP_XO"},{text = '👨‍🎤مــبـرمج السورس 👨‍🎤', url="https://t.me/M_ahmu_d"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AP_XO&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
